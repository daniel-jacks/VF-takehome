...
__Please note:__ 
using `sam deploy` is only responsible for setting up the AWS resources listed above. In order to link these resources to Amazon Connect, I recommend using [AWS Documentation](https://docs.aws.amazon.com/connect/latest/adminguide/amazon-connect-get-started.html****)
